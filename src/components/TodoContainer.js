...
const TodoContainer = (props)=>(
    <div className="todos__display__container">
      ...
      {props.todos.map((todo,index)=> <Todos key={index} index={index} todos={todo.todo} time={todo.time} alltodos={props.todos} handleCheckTodo={props.handleCheckTodo} handleDeleteTodo={props.handleDeleteTodo} />)}
    </div>
)
